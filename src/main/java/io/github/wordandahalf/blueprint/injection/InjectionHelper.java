...
public class InjectionHelper {
	...
	/**
	 * Overwrites a targeted method To be more specific, this renames the targeted method to a unique name, copies the source method to the target
	 * method's class and renames it to ensure it is the same as the target method
	 * @param targetMethod
	 * @param sourceMethod
